...
constexpr int man_values[32]{0,  0, 0,  0, 24, 10, 8,  9,  8,  10, 10,
                             24, 3, 4,  5, 1,  2,  13, 8,  1,  1,  2,
                             1,  0, -1, 7, 9,  25, -5, 23, 10, 32};

/// @brief king value constants
constexpr int king_values[32]{-7, -1, -3, -10, -5, 0,  -1,  -1, 1,  10, 8,
                              -1, -1, 10, 11,  1,  2,  11,  10, -1, -1, 8,
                              10, 0,  -1, -1,  -1, -1, -10, 0,  -1, -7};

/// @brief piece value constants
constexpr int piece_values[4]{100, 1000, -100, -1000};
